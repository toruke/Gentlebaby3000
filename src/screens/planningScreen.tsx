...
export const GuardPlanningScreen: React.FC<Props> = ({
    familyId,
    currentUserId,
    familyMembers,
}) => {
    ...
    useEffect(() => {
        void loadSlots();
    }, [mode, selectedDate, selectedMemberId]);
    ...
    const renderItem = ({ item, index }: { item: PlanningSlot, index: number }) => {
        ...
        // Logique de séparation par jour
        ...
        return (
            <View>
                ...
                {/* CARTE (Ton Design Aesthetic Préféré) */}
                <View style={styles.card}>
                    <View style={styles.cardHeader}>
                        ...
                        <View style={styles.infoContainer}>
                            ...
                            {/* Ajout discret du jour sur la carte aussi */}
                            <Text style={styles.cardMiniDate}>{capitalizedDay}</Text>
                        </View>
                    </View>

                    <View style={styles.cardActions}>
                        {/* Un seul bouton d'action ici, car 'Ajouter' est déplacé en FAB */}
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <TouchableOpacity
                style={styles.fab}
                onPress={() => {
                    // Ici tu mettras la navigation vers l'écran de création (US-202)
